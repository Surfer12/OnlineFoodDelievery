...
public class Order {
    ...
    */
   public Order(final Long customerId, final List<MenuItem> items, final Location deliveryLocation, final String customerEmail) {
      this.validateOrderInputs(customerId, items, deliveryLocation, customerEmail);
   ...
   private void validateOrderInputs(final Long customerId, final List<MenuItem> items, final Location deliveryLocation, final String customerEmail) {
      ...
      if (customerEmail == null || !this.isValidEmail(customerEmail)) {
   ...
   private void validateStatusTransition(final OrderStatus currentStatus, final OrderStatus newStatus) {
    ...
    */
   public void processPayment(final String paymentMethod) {
      try {
         if (this.payment != null) {
            throw new IllegalStateException("Payment has already been processed");
         }

         this.payment = new Payment(this.orderId, paymentMethod, this.totalAmount);
    ...
    */
   public void setEstimatedDeliveryTime(final LocalDateTime time) {
   ...
   public Driver getAssignedDriver() {
      return Driver.getDriverById(this.driverId);
   }
