...
public class CommandLineApplication {
      public static void main(String[] args) {
            try (Scanner scanner = new Scanner(System.in)) {
                  ...
                  ConsoleInputHandler<String> emailInputHandler = new ConsoleInputHandler<>(scanner,
                              emailInputValidator);
                  ...
                  InputValidator<MenuItem> menuItemInputValidator = new InputValidator<>(menuItemValidator,
                              "Menu Item");
                  ...
                  InputValidator<MenuItem> orderItemInputValidator = new InputValidator<>(orderItemValidator,
                              "Order Item");
                  ConsoleInputHandler<MenuItem> orderItemInputHandler = new ConsoleInputHandler<>(scanner,
                              orderItemInputValidator);
                  MenuItem orderItem = orderItemInputHandler.getInput("Enter order item (menuItemId,quantity): ");
                  System.out.println("Order item added with ID: " + orderItem.getId() + " and quantity: "
